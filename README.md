...
- **漫画阅读** - 支持封面浏览、翻页阅读、页面缩略图导航
- **电子书阅读** - 支持章节导航、连续滚动阅读模式
...
- **Comic Reader** - Cover browsing, page-by-page reading, thumbnail navigation
- **Ebook Reader** - Chapter navigation, continuous scroll reading mode
