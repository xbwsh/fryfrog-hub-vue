...
const general: IconItem[] = [
  ...
  { id: 'dropper', name: 'Dropper', nameCn: '取色器', svg: '<path fill="currentColor" stroke="none" d="M18 17.5c1 0 1.9-.8 1.9-1.9 0-1.3-1.9-3.3-1.9-3.3s-1.9 2-1.9 3.3c0 1 .8 1.9 1.9 1.9zM9.3 16.5c.2.2.4.2.6 0l6.1-6.1c.2-.2.2-.4 0-.6l-6.1-6.1c-.1-.1-.3-.3-.5-.4l-1.9-1.9c-.1-.1-.2-.1-.3 0l-1.1 1.1c-.1.1-.1.2 0 .3l1.6 1.6-5 5c-.2.2-.2.4 0 .6l6.1 6.1zM9.6 5.8l4.3 4.3H5.4l4.2-4.3zM21.6 19.5H2.9c-.1 0-.2.1-.2.2v1.9c0 .1.1.2.2.2h18.7c.1 0 .2-.1.2-.2v-1.9c0-.1-.1-.2-.2-.2z"/>' },
  ...
  { id: 'file', name: 'File', nameCn: '文件', svg: '<path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><polyline points="13 2 13 9 20 9"/>' },
  { id: 'file-text', name: 'File Text', nameCn: '日志', svg: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>' },
  ...
  { id: 'star-rating', name: 'Star Rating', nameCn: '评分', svg: '<defs><path id="star" d="M0,-10 L2.94,-3.09 L9.51,-3.09 L4.09,1.18 L6.12,7.79 L0,3.09 L-6.12,7.79 L-4.09,1.18 L-9.51,-3.09 L-2.94,-3.09 Z"/></defs><use href="#star" x="12" y="12" fill="currentColor" stroke="currentColor" stroke-width="0.8"/><use href="#star" x="36" y="12" fill="currentColor" stroke="currentColor" stroke-width="0.8"/><use href="#star" x="60" y="12" fill="currentColor" stroke="currentColor" stroke-width="0.8"/><use href="#star" x="84" y="12" fill="currentColor" stroke="currentColor" stroke-width="0.8"/><use href="#star" x="108" y="12" fill="none" stroke="currentColor" stroke-width="0.8"/>' },
]
